  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* LOGO ZALO */}
        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-white flex items-center justify-center text-[#0068FF] font-black text-[10px] sm:text-[11px] shadow-xs tracking-tighter shrink-0">
          Zalo
        </div>
